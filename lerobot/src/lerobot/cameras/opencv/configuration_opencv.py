...
class OpenCVCameraConfig(CameraConfig):
    ...
    Attributes:
        ...
        exposure: Manual exposure value (integer, e.g. 100). Range depends on camera
                  hardware (typically 1–5000 for V4L2 USB cameras). Set to None to use
                  the camera's automatic exposure. Defaults to None (auto).
